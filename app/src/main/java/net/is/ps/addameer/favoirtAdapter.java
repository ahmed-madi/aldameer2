...
public class  favoirtAdapter extends ArrayAdapter {
    ...
    public favoirtAdapter(Context context, int resource, List<Catagories> objects, Typeface typeFace) {
    ...
    private View.OnClickListener onDeleteListener(final int position, final ViewHolder holder) {
        return new View.OnClickListener() {
            ...
            //    Toast.makeText(getContext(), "this is my Toast message!!! =)", Toast.LENGTH_LONG).show();
                ...
                //// Delete Clicked Item From itemList Code
                ...
                for (int i=0;i<inpList.size();i++) {
                    ...
                    if(x.getId() == itemsModeList.get(position).getId()){
                        ...
                        Favorite oneNewsFragment = new Favorite();
